module.exports = {
  "array": [
    {
      ...
      "tierData": true,
      "tier": "Top",
      "notes": "High damage per shot; projectile munitions. Projectiles explode on impact with an appreciable AOE while also requiring some travel distance which will reduce self damage. High fire rate and low ammo pool is impossible to manage without some manner of ammo mutation or restore. ✪",
      "dmg": "Crit/Status",
      "rank": 32.6,
      "tierRank": 3,
      "component": false
  ...
  "fetched": "2019.12.11 07:48:12 CET+01:00",
  "version": {
    "pc": "Rising Tide: 26.1.3",
    "ps4": "26.0.8",
    "xbox": "26.0.8",
    "switch": "26.0.8",
    "tier": "Warframe Patch 26.1.3 - Everything reranked except Ember, Vauban, and Grendel. Migration to overframe.gg underway. "
  }
}